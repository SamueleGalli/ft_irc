...
void welcome_msg(ft_irc &irc, int i)
{
    ...
    bbuffer = ":" + irc.client[i].server + " 001 " + irc.client[i].nick + " :Welcome to the Internet Relay Network " + irc.client[i].nick + "!" + irc.client[i].user + "@" + irc.client[i].host + irc.client[i].realname +"\r\n";
